			...
			<div class="mui-row" style="padding: 36px 30px 0 30px;">
				...
				<div class="mui-col-xs-12 mui-row">
					...
					<div class="mui-col-xs-8">
						<ul class="assess-start-box mui-col-xs-12">
							<li><i>1</i></li>
							<li><i>2</i></li>
							<li><i>3</i></li>
							<li><i>4</i></li>
				...
				<div class="mui-input-row" style="padding-top: 30px;">
					<textarea name="" rows="5" cols="" placeholder="请添加描述....."></textarea>
				</div>
			</div>
			<div class="mui-button-row mui-col-xs-12" style="position: fixed;bottom: 17px;">
				<button type="button" class="mui-btn mui-badge-red" style="background: #FF0000;">提交评价</button>
			</div>
		</div>
		<script src="${contextPath}/xmMobile/js/mui.min.js"></script>
